...
*/}}
{{- define "gameserver-operator.name" -}}
...
*/}}
{{- define "gameserver-operator.fullname" -}}
...
*/}}
{{- define "gameserver-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "gameserver-operator.resourceName" -}}
{{- $fullname := include "gameserver-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "gameserver-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
